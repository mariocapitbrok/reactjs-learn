...
const productsCat = getProductsCat(products)
const prodNamePrice = getProdNamePrice(products)
const noFormatedProds = getNoFormatedProds()

const coffees = getCoffees()

const DATA = { products, prodNamePrice, coffees, productsCat, noFormatedProds }
...
function getProdNamePrice(products) {
...
function getProductsCat(products) {
